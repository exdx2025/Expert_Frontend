...
import './ENMGExpectation.css'

const ENMGExpectation = () => {
  ...
  return (
    <div className="enmg-test-container">
      {/* <TiTick className="tick-icon" /> */}
      <h1>What to Expect Before, During & After a Electroencephalogram Test</h1>

      {/* Section Navigation */}
      <div className="en-section-nav">
        <button
          className={`en-section-button ${
      ...
      {/* Section Content */}
      <div className="enmg-test-sections">
        {/* Before the Test */}
        {activeSection === "before" && (
          <div className="enmg-test-section">
...
export default ENMGExpectation