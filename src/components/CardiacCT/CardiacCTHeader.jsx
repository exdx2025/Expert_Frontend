...
const CardiacCTHeader = () => {
  ...
  return (
    <div className="CardiacCTHeader-main1">
      ...
      {showForm && (
        <div className="cardiacct-form-overlay">
          ...
          >
            ...
            {/* Right Section: Form */}
            <div className="cardiacct-form-container">
              {/* Close Icon */}
              <button
                className="cardiacct-form-close-icon"
              ...
              >
                ...
                <button type="submit" className="cardiacct-form-submit-btn">
                  Submit
                </button>
              </form>
            </div>
